var $_GET = $_GET(),
    ...
    dateEnd3 = date.toLocaleDateString()
    console.log(dateEnd3)
    var x = new Date();
    x.setDate(0); // 0 will result in the last day of the previous month
    x.setDate(1);
    dateStart = x.toISOString();
    dateStart3 = x.toLocaleDateString()
...
function resellerReport1() {
    ...
    var url = "https://"+ server+".agendize.com/api/2.0/resellers/reporting/full?apikey=" + apiKey + "&token=" + token + "&startDate=" + startDate2 + "&endDate=" + endDate2;
    console.log(url)
